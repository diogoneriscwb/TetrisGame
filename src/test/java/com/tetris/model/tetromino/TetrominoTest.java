 ...
 * Usamos uma classe 'StubTetromino' para testar a lógica abstrata
 * de gerenciamento de estado (troca de rotação).
 */
class TetrominoTest {

    // --- Formas de Teste Simples ---
    // Apenas duas formas simples para testar o ciclo de rotação.
    ...
    // Agora passa a matriz 3D para o construtor da superclasse
    private static class StubTetromino extends Tetromino {
        public StubTetromino() {
            // Passa as formas de teste e uma cor qualquer
            super(TEST_SHAPES, Color.TRANSPARENT);
        }
    }
    // ---------------------------------
    ...
    void testConstructorAndInitialState() {
        // 1. Testa a posição inicial (definida no construtor abstrato)
